...
1. Visit the Figshare page: https://doi.org/10.6084/m9.figshare.20113592.v1
2. Download the dataset files
3. Extract the data locally
4. Place the data in the directory expected by the scripts
...
Evaluation is performed using **participant-level stratified cross-validation**, and performance is assessed using:
